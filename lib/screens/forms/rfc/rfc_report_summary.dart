...
class RfcReportSummary extends StatefulWidget {
  RfcReportSummary(this.template, this.formName, this.dbForm);
  final String formName;
  final DbForm dbForm;
  final FormTemplate template;

  @override
  State<StatefulWidget> createState() => _RfcReportSummaryState(template, formName, dbForm);
}
...
class _RfcReportSummaryState extends State<RfcReportSummary> {
  ...
  _RfcReportSummaryState(this.template, this.formName, this.dbForm);
          ...
          Container(
              child: TextField(
                decoration: InputDecoration(
                    ...
                    hintText: 'Enter feedback for the interviewer here...',
                    labelText: 'Interviewer Feedback'
                ),
                maxLines: 10,
  ...
  Widget generateSummary() {
    return ListView(
        ...
        children: <Widget>[
          ...
          ListTile(
            title: Text("Submission status: ${this.dbForm.rfcAccepted == true ? "Submitted" : "Not submitted"}"),
          ),
          ExpansionPanelList(
          ...
          /*if (dbForm.rfcAccepted == false && dbForm.techLeadAccepted == false) Container(
            margin: EdgeInsets.all(15.0),
            child: Text("This report was rejected by you and the technical lead", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 24.0), textAlign: TextAlign.center,),
          ),*/
          if (dbForm.techLeadAccepted == false) Container(
            margin: EdgeInsets.all(15.0),
            child: Text("This report was rejected by the technical lead", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 24.0), textAlign: TextAlign.center,),
          ),
          if (dbForm.rfcAccepted == false) Container(
            margin: EdgeInsets.all(15.0),
  ...
  void goToDetails() async {
    bool result = await Navigator.push(context, MaterialPageRoute(builder: (BuildContext context) {
      return RfcReportsView(this.template, this.dbForm);
    }));
